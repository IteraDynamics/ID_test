...
## Correction — 2026-09-04: CEO closes Campaign #58 Phase 1 as underpowered

**CEO decision (verbatim short form):** "Yes, close Campaign #58 Phase 1 time-series track as underpowered."

**Disposition:** Campaign #58 Phase 1 (time-series residual-predictability track) is **CLOSED_UNDERPOWERED**.

**Binding evidence unchanged:**
- Grid-level power FAIL: overall average power **45.8%** vs 50% floor at central IC 0.065 on the frozen 144-candidate / 3-family grid (Family R 54.9%, M 41.8%, V 40.6%).
- Independent implementation review verdict **`ORIGINAL_POWER_FAIL_VALID`** (`docs/research/CAMPAIGN_58_GRID_POWER_CALIBRATION_IMPLEMENTATION_REVIEW.md`) — the post-hoc raw≈residualized duplication concern is considered and rejected; 45.8% remains binding; no recalibration rerun.

**What this does not do:**
- Does **not** close Campaign #58 as a whole. Phase 0 (cross-sectional COT census) remains **OPEN**, blocked on data/network access for effective-breadth measurement.
- Does **not** authorize any real Campaign #58 predictor/outcome computation or model fit.
- Does **not** authorize any Core v1 / Core v2 / runtime / portfolio / paper / live / capital change.
- Does **not** reopen or supersede the separate ML Lab Experiment 011/012 record above.
