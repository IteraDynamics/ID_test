"""Layer 2 — TrendFollowingV8 Entry-Cap 60% + Add-on Cap 80%.

Builds on trend_following_v8_ecap60.

Two-level asymmetric cap:
  - Initial entries:  capped at 0.60
  - Add-ons:          capped at 0.80
  - HOLD / EXIT / FLAT: pass through unchanged

Positions travel: 60% (entry) → natural float → 80% max (add-on) → exit.
Peak intentional exposure is 80% instead of 100%.
"""
...
STRATEGY_ID = "trend_following_v8_ecap60_add80"
_ENTRY_CAP = 0.60
_ADDON_CAP = 0.80
