"""Layer 2 — TrendFollowingV8 Entry-Cap 60% (asymmetric exposure control).

Applies the same asymmetric-cap design as trend_following_v8_ecap75 but with
a more conservative 60% NAV ceiling on initial entries.

Signal logic: identical to trend_following_v8.
Only change: ENTER_LONG initial entries capped at 0.60.
...
STRATEGY_ID = "trend_following_v8_ecap60"
_ENTRY_CAP = 0.60
