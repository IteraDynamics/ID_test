"""Layer 2 — Equity SPY SMA Band v1.

Research-only single-asset equity sleeve for Itera Dynamics.

Purpose:
    Convert the salvageable SPY portion of the SPY/QQQ composite book research
    into a directly tradeable, asset-local StrategyIntent.

Design:
    - asset target: SPY or broad S&P 500 proxy
    - timeframe: daily bars
    - signal family: long-only trend-to-cash
    - exposure: binary long / flat within the SPY sleeve
    - no leverage
    - no shorting
...
STRATEGY_ID = "equity_spy_sma_band_v1"
ASSET = "SPY"
...
def generate_intent(
    ...
    """Generate a long/flat daily SMA intent for the SPY sleeve."""
