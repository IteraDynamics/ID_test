"""Layer 2 — TrendFollowingV8 Cap50 (exposure throttle experiment).

Exposure-throttling variant of trend_following_v8.

See trend_following_v8_cap75 for experiment design rationale.
This variant tests a 50% NAV cap — the most conservative of the three.

Signal logic: identical to trend_following_v8 (no changes).
Only change: desired_exposure_frac is capped at 0.50 on every intent.
"""
...
STRATEGY_ID = "trend_following_v8_cap50"
_CAP = 0.50
