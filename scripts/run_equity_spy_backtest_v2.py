#!/usr/bin/env python
"""Itera Dynamics — Equity SPY Trend v2 Backtest Runner.

Runs Equity Sleeve v2 and prints full fund-style diagnostics.
...
def main():
    p = argparse.ArgumentParser(description="Run Equity SPY Trend v2 backtest")
    ...
    print("\n" + "=" * 96)
    print("  SPY DAILY EQUITY TREND v2 — Partial Exposure Research Backtest")
    ...
    print("  " + "-" * 86)
    print_metrics("Strategy v2", strategy_m)
