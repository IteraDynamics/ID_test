...
Purpose:
    Test whether a small short-vol allocation improves portfolio-level metrics
    without introducing unacceptable drawdown or volatility.

Outputs:
    artifacts/four_sleeve_portfolio/
        equity_curves.csv
        daily_returns.csv
...
def main() -> None:
    ...
    print("\n" + "=" * 112)
    print("  ITERA FOUR-SLEEVE PORTFOLIO — Static Research Blend")
